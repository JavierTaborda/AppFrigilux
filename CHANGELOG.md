...
- Added an accounts receivable module with automatic loading, local client search, pull-to-refresh
- Added client account cards showing credit, pending balance, available credit, currency, and credit status.
- Added document detail modal with invoice and credit note labels, formatted totals, issue dates, observations, and delivery note references.

### Fixed

- Font size viiew in create orders
...
- Creayte Order Summary Screen for create order
...
- folder `modules` changed to `features`

### Fixed

### Removed

- colors and AppColors

## [1.0.4] - 2025-11-25

### Added

- Modal for Item in create order

### Changed

- Remplace alert for Alert.alert
- Remplace Expo Haptics with utils safeHaptics
...
## [1.0.3](https://github.com/JavierTaborda/AppFrigilux/releases/tag/v1.0.3) - 2025-11-21

### Added

- MotiveModal for return module and type Motive
...
## [1.0.2](https://github.com/JavierTaborda/AppFrigilux/releases/tag/v1.0.2) - 2025-11-19
...
- safeHaptic utility
  ...
  Available haptic types: -`success` -`warning` -`error` -`selection` -`light` -`medium` -`heavy` -`rigid` -`soft`
